...
function BookEvents() {
  ...
  const [events, ] = useState([
    ...
    { id: 1, name: 'Mastering Piece Movements', level: 'Beginner', rating: '60 Activities', description: 'Free' },
        ...
        {filteredEvents.map(event => (
          <div key={event.id} onClick={() => handleOpen(event.name)}>
            ...
            <div className="gallery-wrapper">
                ...
                <img className="img-fluid w-100 mb-3 img-thumbnail shadow-sm rounded-0" src="https://chesslang-academy-images.s3.amazonaws.com/1648818639078..jpg" alt="" />
